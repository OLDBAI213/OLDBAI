...
namespace ICE.Ui.MainUi.Settings
{
    internal class GatherSettings
    {
        ...
        private static readonly string MaxUseHelpText = "Set to -1 to allow for infinite uses \n" +
                                                        "Set to 1-> X to set maximum amount of uses per mission";

        private static string[] TranslateLabels(string[] labels)
            => Array.ConvertAll(labels, T);
        ...
        public static void Draw()
        {
            ...
            if (ImGui.CollapsingHeader(T("Cordial Settings")))
            {
                ...
                var rankLabels = TranslateLabels(RankLabels);
            ...
            if (ImGui.BeginTable("Gathering Profile Settings", 2, ImGuiTableFlags.SizingFixedFit))
            {
                ...
                var missionTypes = TranslateLabels(MissionTypes);
                if (ImGui.Combo(T("Mission Type"), ref missionIndex, missionTypes, missionTypes.Length))
                ...
                if (ImGui.CollapsingHeader(T("Pioneer's | Mountaineer's Gift II")))
                {
                    ...
                    ImGuiEx.HelpMarker(T(ActionInfo));
                ...
                if (ImGui.CollapsingHeader(T("Pioneer's | Mountaineer's Gift I")))
                {
                    ...
                    ImGuiEx.HelpMarker(T(MaxUseHelpText));
